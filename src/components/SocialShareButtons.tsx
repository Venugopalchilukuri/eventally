...
export default function SocialShareButtons({ event, compact = false }: SocialShareButtonsProps) {
    ...
    return (
      <div className="relative">
        <button
          ...
          className="p-3 bg-gray-200 dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors"
          title="Share event"
        >
        ...
        {showShareMenu && (
          <>
            ...
            />
            <div className="absolute right-0 top-full mt-2 bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 py-2 min-w-[200px] z-20">
              <button
  ...
  return (
    <div className="space-y-3">
      <p className="text-sm font-semibold text-gray-700 dark:text-gray-300">Share this event:</p>
